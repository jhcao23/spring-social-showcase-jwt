...
import technology.touchmars.showcase.model.ConnectionProperty;
...
public class JpaConnectionRepository implements ConnectionRepository {
	...
	public MultiValueMap<String, Connection<?>> findAllConnections() {
		...
		List<ConnectionProperty> connectionPropertyList = userConnectionRepository.findByTouchUserIdOrderByProviderIdAscRankAsc(userId);
	...
	public List<Connection<?>> findConnections(String providerId) {
		List<ConnectionProperty> connectionPropertyList = 
			userConnectionRepository.findByTouchUserIdAndProviderIdOrderByRankAsc(userId, providerId);
	...
	public Connection<?> getConnection(ConnectionKey connectionKey) {
		...
		Optional<UserConnection> cp = 
			userConnectionRepository.findByTouchUserIdAndProviderIdAndProviderUserId(
	...
	public void addConnection(Connection<?> connection) {
		try {
			...
			Integer rank = userConnectionRepository.findNextRankByTouchUserIdAndProviderId(userId, data.getProviderId());
	...
	public void removeConnections(String providerId) {
		userConnectionRepository.deleteByTouchUserIdAndProviderId(userId, providerId);
//		userConnectionRepository.deleteByProviderId(providerId);
	}

	public void removeConnection(ConnectionKey connectionKey) {
		userConnectionRepository.deleteByTouchUserIdAndProviderIdAndProviderUserId(
			userId, connectionKey.getProviderId(), connectionKey.getProviderUserId()
		);				
	}
	...
	private Connection<?> findPrimaryConnection(String providerId) {
		Optional<ConnectionProperty> cps = userConnectionRepository.findTopByTouchUserIdAndProviderIdOrderByRankAsc(userId, providerId);
		if(cps.isPresent()){
